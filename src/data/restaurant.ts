import { FullRestaurantInfo } from "@/types/restaurant";

export const restaurantData: FullRestaurantInfo = {
  restaurantData: {
    ...
    externalPages: [
      {
        ...
        type: "Image",
        imageURL:
          "https://liwamenu.pentegrasyon.net/images/restaurants/3ad80bb6-1645-42a6-82b1-afd578728c53.png",
        htmlBody: null,
        buttonName: "Our best menus",
        sortOrder: 0,
      },
    ],
    ...
    surveySettings: {
      ...
      enabled: true,
      categories: [
        { id: "sc-001", key: "food", icon: "🍽️", iconName: "UtensilsCrossed", labelKey: "survey.categories.food", averageRating: 0, ratingCount: 0 },
        { id: "sc-002", key: "service", icon: "👥", iconName: "Users", labelKey: "survey.categories.service", averageRating: 0, ratingCount: 0 },
        { id: "sc-003", key: "ambiance", icon: "✨", iconName: "Sparkles", labelKey: "survey.categories.ambiance", averageRating: 0, ratingCount: 0 },
        { id: "sc-004", key: "hygiene", icon: "🧼", iconName: "SprayCan", labelKey: "survey.categories.hygiene", averageRating: 0, ratingCount: 0 },
        { id: "sc-005", key: "staff", icon: "👨‍🍳", iconName: "UserCheck", labelKey: "survey.categories.staff", averageRating: 0, ratingCount: 0 },
      ],
    },
    workingHours: [
