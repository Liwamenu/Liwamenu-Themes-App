  ...
  const renderTab = (
    ...
    <motion.button
      ...
      className={cn(
        ...
        isActive
          ? "font-bold border-[hsl(var(--brand-green))] bg-card text-foreground dark:bg-[hsl(var(--brand-green-deep))] dark:text-white dark:border-[hsl(var(--brand-green-deep))]"
    ...
    >
      ...
      {isActive && (
        <span
          className="absolute left-[15%] right-[15%] -bottom-1 h-1 rounded-full bg-[hsl(var(--brand-green))]"
          aria-hidden="true"
        />
      )}
    </motion.button>
