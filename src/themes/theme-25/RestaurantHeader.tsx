      ...
      <div className="relative h-56 sm:h-72 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 z-10">
          <div className="container px-4 py-3 flex items-center justify-between">
            ...
            >
              <div className="w-12 h-12 rounded-full overflow-hidden shadow-lg border-2 border-white/60 ring-2 ring-[hsl(var(--brand-orange))]/40">
                <img
            ...
            <button
              ...
              aria-label="Menu"
              className="relative w-11 h-11 rounded-full bg-white/95 hover:bg-white shadow-lg flex items-center justify-center text-[hsl(var(--brand-orange))] transition-colors"
            >
        ...
        <div className="overflow-hidden bg-card py-2 border-y border-border">
          ...
          >
            {[...Array(10)].map((_, i) => (
              <span
                key={i}
                className="text-base font-semibold text-[hsl(var(--brand-orange))] mx-8 tracking-wide uppercase"
              >
                {restaurant.slogan1 || restaurant.slogan2}
              </span>
            ))}
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-border">
                <h3 className="text-xl font-bold text-[hsl(var(--brand-orange))] tracking-tight">
                  {restaurant.name}
                </h3>
                <button
                  onClick={closeDrawer}
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-2">
                  ...
                  <div className="space-y-2 mb-3 pb-3 border-b border-border">
                    ...
                    {orders.map((order) => (
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-[hsl(var(--brand-orange))] text-white shadow-md hover:opacity-90 transition-opacity text-left"
                      >
                ...
                {restaurant.reservationSettings?.isActive && (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-3 rounded-xl border border-border hover:border-[hsl(var(--brand-orange))] hover:bg-secondary transition-colors"
                  >
                    <CalendarDays className="w-5 h-5 text-[hsl(var(--brand-orange))]" />
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl border border-border hover:border-[hsl(var(--brand-orange))] hover:bg-secondary transition-colors"
                >
                  <Star className="w-5 h-5 text-[hsl(var(--brand-orange-bright))]" />
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            isActive
                              ...
                              : "border-border hover:border-[hsl(var(--brand-orange))]/40 text-muted-foreground hover:text-foreground",
                          )}
                        >
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            isActive
                              ? "bg-[hsl(var(--brand-orange))]/10 text-[hsl(var(--brand-orange))] font-semibold"
                ...
                <div className="pt-3 border-t border-border space-y-2">
                  {restaurant.phoneNumber && (
                    ...
                    >
                      <Phone className="w-5 h-5 text-[hsl(var(--brand-orange))]" />
                  ...
                  {(restaurant.latitude || restaurant.longitude) && (
                    <a
                      ...
                      className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-secondary transition-colors"
                    >
                      <MapPin className="w-5 h-5 text-[hsl(var(--brand-orange))]" />
