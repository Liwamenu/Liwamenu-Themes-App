...
export function MenuPage() {
  ...
  return (
    <div className="theme-7 min-h-screen bg-background">
      ...
      {/* Menu Categories - single column horizontal cards (1px from screen edges) */}
      <div className="container px-[1px] py-6 pb-24">
        {!searchQuery && campaignProducts.length > 0 && activeCategory === CAMPAIGN_CATEGORY_ID && (
          <section ref={(el) => (categoryRefs.current[CAMPAIGN_CATEGORY_ID] = el)} className="mb-8">
            <h2 className="font-display text-lg font-bold mb-4 flex items-center gap-2 px-3">
