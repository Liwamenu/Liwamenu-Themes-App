...
export function MenuPage() {
  ...
  return (
    <div className="theme-21 min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-50 bg-card/95 backdrop-blur-md border-b border-border shadow-sm">
        <div className="container px-4 py-3">
          <div className="flex gap-2 items-center">
            {/* Call Waiter — pinned to the left of the search box (green tones) */}
            {restaurant.showWaiterCallButton !== false && (
              <button
              onClick={handleOpenCallWaiterFloating}
              disabled={waiterCooldown > 0}
              aria-label={t("waiter.title")}
              className={`shrink-0 h-11 px-3 rounded-2xl flex items-center gap-1.5 text-sm font-medium transition-all ${
                waiterCooldown > 0
