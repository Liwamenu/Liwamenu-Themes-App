    ...
    <header className="relative">
      ...
      <div className="relative h-64 sm:h-80 overflow-hidden">
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
          {!isRestaurantActive ? (
            <div className="flex items-center gap-2 px-4 py-2 bg-destructive text-black text-sm font-semibold rounded-full shadow-lg">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-destructive/90 text-black text-sm font-semibold rounded-full shadow-lg animate-pulse-subtle">
      ...
      {/* Scrolling Marquee */}
      <div className="overflow-hidden bg-background py-2 font-roboto border-y border-border">
        <motion.div
          animate={{ x: [0, -1000] }}
        ...
        >
          {(restaurant.slogan1 || restaurant.slogan2) &&
            [...Array(10)].map((_, i) => (
              <span key={i} className="text-lg font-bold text-foreground mx-8">
                {restaurant.slogan1 || restaurant.slogan2}
              </span>
            ))}
        </motion.div>
