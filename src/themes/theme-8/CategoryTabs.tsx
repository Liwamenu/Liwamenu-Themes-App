      ...
      <div ref={scrollRef} className="flex overflow-x-auto hide-scrollbar gap-3 px-4 py-3">
        {campaignTab && campaignTab.count > 0 && (
          <motion.button
            ...
            className={cn(
              'flex-shrink-0 flex items-center gap-1.5 px-6 py-3 text-[15px] font-bold transition-colors duration-200 whitespace-nowrap',
        ...
        {categories.map((category) => {
          ...
          return (
            <motion.button
              ...
              style={{ borderRadius: LEAF_RADIUS }}
              className={cn(
                'flex-shrink-0 px-6 py-3 text-[15px] font-bold transition-colors duration-200 whitespace-nowrap',
                isActive
