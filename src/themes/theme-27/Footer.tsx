    ...
    <footer className="bg-card border-t border-border mt-10">
      <div className="container px-4 py-12">
        {socialLinks.length > 0 && (
          <div className="mb-10">
            <h3 className="text-center mb-6 text-lg font-bold tracking-tight text-[hsl(var(--brand-green))]">{t("footer.followUs")}</h3>
        ...
        <div className="max-w-sm mx-auto">
          <h3 className="text-center mb-6 text-lg font-bold tracking-tight text-[hsl(var(--brand-green))]">{t("footer.workingHours")}</h3>
