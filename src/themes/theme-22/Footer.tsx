    ...
    <footer className="bg-card border-t border-border mt-10">
      <div className="container px-4 py-12">
        {socialLinks.length > 0 && (
          <div className="mb-10">
            <h3 className="font-script text-center mb-6 text-4xl text-[hsl(var(--sushi-red))]">{t("footer.followUs")}</h3>
        ...
        <div className="max-w-sm mx-auto">
          <h3 className="font-script text-center mb-6 text-4xl text-[hsl(var(--sushi-red))]">{t("footer.workingHours")}</h3>
